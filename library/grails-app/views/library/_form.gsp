...
<div class="fieldcontain ${hasErrors(bean: libraryInstance, field: 'books', 'error')} ">
	...
	<g:select name="books" from="${com.Book.list()}" multiple="multiple" optionKey="id" size="5" value="${libraryInstance?.books*.id}" class="many-to-many"/>
...
<div class="fieldcontain ${hasErrors(bean: libraryInstance, field: 'librarians', 'error')} ">
	...
	<g:select name="librarians" from="${com.Librarian.list()}" multiple="multiple" optionKey="id" size="5" value="${libraryInstance?.librarians*.id}" class="many-to-many"/>
...
<div class="fieldcontain ${hasErrors(bean: libraryInstance, field: 'students', 'error')} ">
	...
	<g:select name="students" from="${com.Student.list()}" multiple="multiple" optionKey="id" size="5" value="${libraryInstance?.students*.id}" class="many-to-many"/>
